  ...
  public: {
    ...
    Tables: {
      ...
      inkflow_studios: {
        ...
        Insert: Omit<
          Database['public']['Tables']['inkflow_studios']['Row'],
      ...
      inkflow_appointments: {
        ...
        Insert: Omit<
          Database['public']['Tables']['inkflow_appointments']['Row'],
          'created_at' | 'updated_at'
      ...
      inkflow_clients: {
        ...
        Insert: Omit<
          Database['public']['Tables']['inkflow_clients']['Row'],
          'created_at' | 'updated_at'
        > & { created_at?: string; updated_at?: string };
      ...
      inkflow_flash_designs: {
        ...
        Insert: Omit<
          Database['public']['Tables']['inkflow_flash_designs']['Row'],
          'created_at' | 'updated_at'
        > & { created_at?: string; updated_at?: string };
      ...
      inkflow_notifications: {
        ...
        Insert: Omit<Database['public']['Tables']['inkflow_notifications']['Row'], 'created_at'> & {
          created_at?: string;
        };
      ...
      inkflow_bookings: {
        ...
        Insert: Omit<
          Database['public']['Tables']['inkflow_bookings']['Row'],
          'created_at' | 'updated_at'
        > & { created_at?: string; updated_at?: string; reference_images?: string[] };
      ...
      inkflow_push_subscriptions: {
        ...
        Insert: Omit<
          Database['public']['Tables']['inkflow_push_subscriptions']['Row'],
          'id' | 'created_at'
      ...
      inkflow_health_forms: {
        ...
        Insert: Omit<
          Database['public']['Tables']['inkflow_health_forms']['Row'],
