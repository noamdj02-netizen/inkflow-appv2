    ...
    return (
      <div className="space-y-3">
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400">
          Les notifications push ne sont pas disponibles dans ce navigateur. Pour les activer, installez l&apos;application sur votre écran d&apos;accueil (PWA) via Safari sur iOS ou Chrome sur Android.
        </p>
      </div>
    );
  }
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-amber-700 dark:text-amber-300/80 mt-0.5">
                Le navigateur a mémorisé votre refus. Vous devez l&apos;autoriser manuellement dans les réglages.
              </p>
            </div>
          </div>
          ...
          {isIos() && (
            <div className="flex items-center gap-2 pt-1 border-t border-amber-200 dark:border-amber-500/20">
              ...
              <p className="text-[11px] text-amber-700 dark:text-amber-400">
                Sur iOS, les notifications push nécessitent que l&apos;app soit installée (bouton <strong>Partager → Ajouter à l&apos;écran d&apos;accueil</strong>).
              </p>
            </div>
          )}
        </div>
        ...
        <>
          ...
          <div className="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50 p-3 flex items-start gap-3">
            ...
            <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed">
              ...
              <strong className="text-zinc-800 dark:text-zinc-200">« Autoriser »</strong> pour recevoir les alertes de nouveaux RDV et messages directement sur cet appareil.
            </p>
          </div>
          <button
            type="button"
