  ...
  [
    {
      ...
      desc: "Accès complet — gère les abonnements et l'équipe",
    },
    {
      id: 'tatoueur',
      label: 'Tatoueur',
    ...
    },
    {
      ...
      desc: 'Accès limité — lecture seule sur les RDV',
    },
  ];
...
interface EtablissementPageProps {
  ...
  onAddArtist: (
    a: Omit<ArtistAccount, 'id' | 'createdAt' | 'studioId'> | ArtistAccount
  ) => void | Promise<void>;
    ...
    <div className="animate-fade-in w-full max-w-2xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <div className="flex items-center gap-3 px-5 py-4 border-b border-zinc-100 dark:border-zinc-800">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400 dark:text-zinc-500">
              Informations légales et artistiques du studio
            </p>
          </div>
        </div>
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex justify-end pt-1">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm bg-blue-600 text-white dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-400  disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-[0.98]"
            >
              {savingIdentity ? (
                <>
      ...
      <section className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
        <div className="flex items-center gap-3 px-5 py-4 border-b border-zinc-100 dark:border-zinc-800">
          ...
          <div>
            <h2 className="font-semibold text-sm text-zinc-900 dark:text-white">
              Avis Google sur votre vitrine
            </h2>
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
              Vos clients voient votre note comme sur Google. Une étape : collez le lien de votre
              fiche.
            </p>
          </div>
        </div>
            ...
            <>
              {googlePlaceId ? (
                <div className="space-y-3">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 rounded-xl border border-blue-200 dark:border-blue-500/30 bg-blue-50/80 dark:bg-blue-500/10 px-4 py-3">
                    <div className="min-w-0 flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-zinc-500 dark:text-zinc-400">
                          Les avis s’affichent sur votre vitrine.
                        </p>
                      </div>
                    </div>
                    <button
              ...
              {!googlePlaceId && (
                <div className="rounded-xl bg-zinc-50 dark:bg-zinc-800/40 border border-zinc-100 dark:border-zinc-800 p-4 space-y-4">
                  <p className="text-sm text-zinc-700 dark:text-zinc-200 leading-relaxed">
                    Sur <strong>Google Maps</strong>, ouvrez la page de votre studio. Copiez le{' '}
                    <strong>lien en haut</strong> (barre d’adresse du navigateur) et collez-le ici.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-2">
                    ...
                    <button
                      ...
                      className="shrink-0 min-h-[48px] px-5 rounded-xl text-sm font-semibold bg-blue-600 text-white dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-400  disabled:opacity-50 transition-all active:scale-[0.98]"
                    >
                      {savingGooglePlace ? (
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
                    Évitez le bouton « Partager » (lien trop court). Si vous collez un lien court,
                    Inkflow essaie de le compléter automatiquement ; sinon, copiez l’URL de la barre
                    d’adresse ou un code <span className="font-mono text-[11px]">ChIJ…</span>.
                  </p>
                      ...
                      {!showGoogleBusinessOAuth ? (
                        <div className="space-y-3">
                          <p className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-relaxed">
                            Tant que l’OAuth Google Business Profile n’est pas activé pour ce
                            déploiement, utilisez le champ ci-dessus (URL ou Place ID) pour les avis
                            publics sur la vitrine. Complétez avec des témoignages dans Paramètres →
                            Page vitrine → Avis clients.
                          </p>
                            ...
                            <div className="flex items-center justify-between gap-3 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900/60 px-4 py-3">
                              <div className="min-w-0">
                                ...
                                <p className="text-[11px] text-amber-600 dark:text-amber-400/90 mt-0.5">
                                  OAuth désactivé côté app — vous pouvez déconnecter pour nettoyer.
                                </p>
                              </div>
                              <button
                                type="button"
                        ...
                        <>
                          <p className="text-[11px] text-zinc-500 dark:text-zinc-400">
                            Connectez votre Google Business pour afficher vos avis sur la vitrine
                            (API Google, quotas).
                          </p>
                          {googleBusinessConnected ? (
                            <div className="space-y-3">
                            ...
                            <button
                              ...
                              disabled={
                                connectingBusiness || !useSupabase || !onConnectGoogleBusiness
                              }
      ...
      <section className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
        <div className="flex items-center gap-3 px-5 py-4 border-b border-zinc-100 dark:border-zinc-800">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400 dark:text-zinc-500">
              Gérer votre plan et vos factures
            </p>
          </div>
        </div>
        ...
        <div className="p-5 space-y-4">
          ...
          >
            <div>
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                {isActive
                  ? 'Plan Solo — renouvellement mensuel'
                  : inTrial
                    ? 'Passez à un plan payant pour continuer'
                    : "Abonnez-vous pour débloquer l'accès"}
              </p>
            </div>
            <button
              onClick={onGoToBilling}
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold bg-blue-600 text-white dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-400  transition-all active:scale-[0.98]"
            >
