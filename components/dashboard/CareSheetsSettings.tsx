...
export const CareSheetsSettings: React.FC<CareSheetsSettingsProps> = ({
  userEmail,
  studioName,
}) => {
  ...
  useEffect(() => {
    if (studioId && useSupabase) {
      getCareTemplatesFromSupabase(studioId)
        .then((fromDb) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-blue-600 text-white dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-400 rounded-xl font-medium  transition-colors"
          >
      ...
      {templates.length === 0 ? (
        <div className="bg-white dark:bg-zinc-900 rounded-2xl p-12 border border-zinc-200 dark:border-zinc-800 text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <button
              onClick={createTemplate}
              className="px-5 py-2.5 bg-blue-600 text-white dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-400 rounded-xl font-medium  transition-colors"
            >
              Créer de zéro
            </button>
          </div>
              ...
              {templates.map((t) => (
                <button
                  ...
                  className={`w-full text-left px-4 py-3.5 transition-colors ${
                    selectedId === t.id
                      ? 'bg-zinc-50 dark:bg-zinc-800 border-l-2 border-blue-600 dark:border-blue-500'
              ...
              <>
                ...
                <div className="px-5 py-4 border-t border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-400 rounded-xl font-medium  transition-colors disabled:opacity-50"
                  >
