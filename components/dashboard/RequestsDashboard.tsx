...
import { MessageSquare, CheckCircle, XCircle, Calendar, FileText, Mail } from 'lucide-react';
import { EmptyState } from '../common/EmptyState';
import { Appointment, ProjectRequest } from '../../types';
...
export const RequestsDashboard: React.FC<RequestsDashboardProps> = ({
  ...
  const { user } = useAuth();
  const [activeTab, setActiveTab] = useState<'rdv' | 'projects' | 'history'>('rdv');
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2 overflow-x-auto">
          ...
          <button onClick={() => setActiveTab('projects')}
            ...
            Demandes de projet ({pendingProjects.length})
          </button>
