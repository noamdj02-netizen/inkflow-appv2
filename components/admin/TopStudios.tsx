  ...
  return (
    <div className="rounded-xl border border-[var(--admin-border)] bg-[var(--admin-card)] p-6">
      <div className="mb-4 flex items-center gap-2">
        <Trophy className="h-5 w-5 text-[var(--admin-text-muted)]" aria-hidden />
              ...
              >
                <div className="mb-2 flex items-start justify-between">
                  <div className="flex items-center gap-2">
                    <span className="tabular-nums text-sm font-semibold text-[var(--admin-text-muted)]">
                      {index + 1}.
                    </span>
                    <div>
                      <p className="font-sans text-sm font-semibold text-[var(--admin-text)]">
                        {studio.slug}
                      </p>
                      <p className="text-xs text-[var(--admin-text-muted)]">Slug public</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-1 text-xs font-medium text-[var(--admin-text-muted)]">
                ...
                <div className="mt-3 h-1 overflow-hidden rounded-full bg-[var(--admin-border)]">
                  <div
                    className={`h-full transition-all ${isTop ? 'bg-[var(--admin-chart-line)]' : 'bg-[var(--admin-text-muted)]'}`}
