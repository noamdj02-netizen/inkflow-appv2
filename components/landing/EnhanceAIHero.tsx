...
export const EnhanceAIHero: React.FC = () => {
  ...
  return (
    <section
      className="landing-hero relative flex min-h-[100dvh] w-full min-w-0 flex-col overflow-hidden pt-[calc(3.5rem+env(safe-area-inset-top,0px))] pb-20 sm:pb-24 md:pt-[calc(4.25rem+env(safe-area-inset-top,0px))] md:pb-24 lg:pb-24"
      data-gsap-hero
    >
