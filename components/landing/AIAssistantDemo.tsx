        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <div className="px-3 py-2 rounded-xl bg-neutral-50 border border-neutral-200 text-neutral-800">{placement}</div>
            </div>
            <div>
              <label className="text-neutral-500 block mb-1">Taille</label>
              <div className="px-3 py-2 rounded-xl bg-neutral-50 border border-neutral-200 text-neutral-800">{size}</div>
            </div>
          </div>
          <button
