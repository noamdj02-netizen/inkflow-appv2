...
function App() {
  return (
    <Image src="https://via.placeholder.com/300x200" alt="示例图片" width={300} height={200} />
  );
}
```
...
function App() {
  return (
    <Image src="https://via.placeholder.com/300x200" alt="示例图片" width={300} height={200} lazy />
  );
}
```
...
function App() {
  return (
    <>
      <Image src="https://via.placeholder.com/300x200" width={150} height={150} fit="contain" />
      <Image src="https://via.placeholder.com/300x200" width={150} height={150} fit="cover" />
      <Image src="https://via.placeholder.com/300x200" width={150} height={150} fit="fill" />
    </>
  );
}
```
