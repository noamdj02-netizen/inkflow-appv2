...
function App() {
  ...
  return (
    <>
      <Button onClick={() => setVisible(true)}>显示遮罩</Button>
      <Mask visible={visible} onMaskClick={() => setVisible(false)} opacity={0.5} />
    </>
  );
}
```
...
function App() {
  ...
  return (
    <>
      <Button onClick={() => setVisible(true)}>显示遮罩</Button>
      <Mask visible={visible} onMaskClick={() => setVisible(false)}>
        <div style={{ padding: '20px', background: '#fff', borderRadius: '8px' }}>内容</div>
      </Mask>
    </>
  );
}
...
function App() {
  ...
  return (
    <>
      <Button onClick={() => setVisible(true)}>显示遮罩</Button>
      <Mask visible={visible} onMaskClick={() => setVisible(false)} disableBodyScroll={false} />
    </>
  );
}
```
