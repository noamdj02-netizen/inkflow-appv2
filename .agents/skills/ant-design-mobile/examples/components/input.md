...
function App() {
  ...
  return <Input placeholder="Enter text" value={value} onChange={(val) => setValue(val)} />;
}
```
...
function App() {
  ...
  return (
    <Input placeholder="Enter text" value={value} onChange={(val) => setValue(val)} clearable />
  );
}
```
...
function App() {
  return <Input placeholder="Search" prefix={<SearchOutline />} />;
}
```
...
function App() {
  ...
  return <Input placeholder="Enter text" value={value} onChange={handleChange} error={error} />;
}
```
