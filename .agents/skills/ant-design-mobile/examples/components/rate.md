...
function App() {
  ...
  return <Rate value={value} onChange={(val) => setValue(val)} />;
}
```
...
function App() {
  ...
  return (
    <>
      <Rate value={value} onChange={(val) => setValue(val)} count={5} />
      <Rate value={value} onChange={(val) => setValue(val)} count={10} />
    </>
  );
}
```
...
function App() {
  ...
  return <Rate value={value} onChange={(val) => setValue(val)} allowHalf />;
}
```
...
function App() {
  ...
  return <Rate value={value} onChange={(val) => setValue(val)} character={<HeartFill />} />;
}
```
