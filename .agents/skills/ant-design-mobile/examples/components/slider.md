...
function App() {
  ...
  return <Slider value={value} onChange={(val) => setValue(val)} />;
}
```
...
function App() {
  ...
  return <Slider value={value} onChange={(val) => setValue(val)} min={0} max={100} />;
}
```
...
function App() {
  ...
  return <Slider value={value} onChange={(val) => setValue(val)} min={0} max={100} step={10} />;
}
```
...
function App() {
  ...
  return <Slider value={value} onChange={(val) => setValue(val)} min={0} max={100} range />;
}
```
