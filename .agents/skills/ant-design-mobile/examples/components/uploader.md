...
function App() {
  ...
  return <Uploader value={fileList} onChange={setFileList} />;
}
```
...
function App() {
  ...
  return <Uploader value={fileList} onChange={setFileList} preview />;
}
```
...
function App() {
  ...
  return <Uploader value={fileList} onChange={setFileList} multiple />;
}
```
...
function App() {
  ...
  return <Uploader value={fileList} onChange={setFileList} maxCount={3} />;
}
```
...
function App() {
  ...
  return <Uploader value={fileList} onChange={setFileList} upload={upload} />;
}
```
