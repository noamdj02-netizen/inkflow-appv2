  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        <a href={`/discover/${citySlug}`} style={{ fontSize: 13, color: U.textMuted, textDecoration: 'none' }}>
          {cityName}
        </a>
        <span style={{ color: U.borderStrong }}>/</span>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '32px 24px' }}>
        <div style={{ marginBottom: 24 }}>
          <h1 style={{
            ...
            {' '}à{' '}
            <span style={{ color: U.chipActiveBg }}>{cityName}</span>
          </h1>
        ...
        {loading ? (
          ...
          <div style={{ padding: '80px 0', textAlign: 'center', color: U.textMuted, fontSize: 14 }}>
            ...
            <br />
            <a href={`/discover/${citySlug}`} style={{ color: U.accent, marginTop: 12, display: 'inline-block' }}>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: 18, fontWeight: 700, color: U.text, marginBottom: 12, letterSpacing: '-0.02em' }}>
