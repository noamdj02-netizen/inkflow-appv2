...
import {
  LayoutGrid, MessageCircle, Calendar, Users,
  Store, TrendingUp, Settings, LogOut, Gift,
  ChevronRight, BookOpen, Sliders, Bell, Search,
  Plus, Image, CreditCard, Clock, CheckCircle,
  ArrowUpRight, Star, Sparkles, X, Menu, ExternalLink,
  Eye, Zap, Target, Award, Heart, ChevronLeft, Play,
  Palette, Globe, Share2, Mail, Phone, MapPin,
...
const DEMO_CLIENTS = [
  { id: '1', name: 'Marie Dupont', email: 'marie.dupont@email.com', phone: '+33 6 12 34 56 78', avatar: DEMO_AVATARS[0], totalSpent: 1250, appointmentsCount: 5, status: 'vip', lastVisit: '2024-03-14' },
  { id: '2', name: 'Lucas Martin', email: 'lucas.martin@email.com', phone: '+33 6 23 45 67 89', avatar: DEMO_AVATARS[1], totalSpent: 380, appointmentsCount: 2, status: 'active', lastVisit: '2024-03-10' },
  { id: '3', name: 'Emma Bernard', email: 'emma.b@email.com', phone: '+33 6 34 56 78 90', avatar: DEMO_AVATARS[2], totalSpent: 720, appointmentsCount: 3, status: 'active', lastVisit: '2024-03-08' },
  { id: '4', name: 'Thomas Petit', email: 'thomas.petit@email.com', phone: '+33 6 45 67 89 01', avatar: DEMO_AVATARS[3], totalSpent: 2100, appointmentsCount: 8, status: 'vip', lastVisit: '2024-03-12' },
  { id: '5', name: 'Léa Laurent', email: 'lea.l@email.com', phone: '+33 6 56 78 90 12', avatar: DEMO_AVATARS[4], totalSpent: 450, appointmentsCount: 2, status: 'active', lastVisit: '2024-03-05' },
  { id: '6', name: 'Hugo Moreau', email: 'hugo.m@email.com', phone: '+33 6 67 89 01 23', avatar: DEMO_AVATARS[5], totalSpent: 890, appointmentsCount: 4, status: 'active', lastVisit: '2024-03-11' },
  { id: '7', name: 'Chloé Dubois', email: 'chloe.d@email.com', phone: '+33 6 78 90 12 34', avatar: DEMO_AVATARS[6], totalSpent: 1680, appointmentsCount: 6, status: 'vip', lastVisit: '2024-03-13' },
  { id: '8', name: 'Nathan Simon', email: 'nathan.s@email.com', phone: '+33 6 89 01 23 45', avatar: DEMO_AVATARS[7], totalSpent: 290, appointmentsCount: 1, status: 'active', lastVisit: '2024-03-09' },
];

const DEMO_APPOINTMENTS = [
  { id: '1', clientId: '1', time: '10:00', service: 'Manchette florale japonaise', status: 'confirmed', price: 450, deposit: 100, depositPaid: true, duration: 180 },
  { id: '2', clientId: '2', time: '14:30', service: 'Flash minimaliste lune', status: 'pending', price: 120, deposit: 30, depositPaid: false, duration: 60 },
  { id: '3', clientId: '3', time: '17:00', service: 'Retouche papillon', status: 'confirmed', price: 80, deposit: 0, depositPaid: true, duration: 45 },
];
...
const DEMO_FLASH_GALLERY = [
  { id: '1', image: 'https://images.unsplash.com/photo-1611501275019-9b5cda994e8d?w=300&h=300&fit=crop', title: 'Serpent géométrique', price: 180, available: true },
  { id: '2', image: 'https://images.unsplash.com/photo-1568515045052-f9a854d70bfd?w=300&h=300&fit=crop', title: 'Rose traditionnelle', price: 150, available: true },
  { id: '3', image: 'https://images.unsplash.com/photo-1590246814883-57c511e76543?w=300&h=300&fit=crop', title: 'Papillon minimaliste', price: 120, available: false },
  { id: '4', image: 'https://images.unsplash.com/photo-1562962230-16e4623d36e6?w=300&h=300&fit=crop', title: 'Crâne mexicain', price: 220, available: true },
  { id: '5', image: 'https://images.unsplash.com/photo-1475180098004-ca77a66827be?w=300&h=300&fit=crop', title: 'Dragon japonais', price: 350, available: true },
  { id: '6', image: 'https://images.unsplash.com/photo-1542359649-31e03cd4d909?w=300&h=300&fit=crop', title: 'Lune et étoiles', price: 90, available: true },
];

const DEMO_REQUESTS = [
  { id: '1', client: DEMO_CLIENTS[1], type: 'rdv', message: 'Bonjour, je souhaiterais réserver un créneau pour un tatouage sur l\'avant-bras...', date: 'Il y a 2h', status: 'pending' },
  { id: '2', client: DEMO_CLIENTS[4], type: 'flash', message: 'J\'adore le flash "Serpent géométrique" ! Est-il toujours disponible ?', date: 'Il y a 5h', status: 'pending' },
  { id: '3', client: DEMO_CLIENTS[7], type: 'projet', message: 'Je cherche un artiste pour une manchette complète style japonais...', date: 'Hier', status: 'pending' },
];

const DEMO_TRANSACTIONS = [
  { id: '1', client: DEMO_CLIENTS[0], type: 'payment', amount: 450, date: '15 mars 2024', method: 'Carte' },
  { id: '2', client: DEMO_CLIENTS[3], type: 'deposit', amount: 150, date: '14 mars 2024', method: 'Stripe' },
  { id: '3', client: DEMO_CLIENTS[6], type: 'payment', amount: 280, date: '13 mars 2024', method: 'Espèces' },
  { id: '4', client: DEMO_CLIENTS[1], type: 'deposit', amount: 50, date: '12 mars 2024', method: 'Stripe' },
  { id: '5', client: DEMO_CLIENTS[2], type: 'payment', amount: 180, date: '11 mars 2024', method: 'Carte' },
];

const DEMO_WEEK_APPOINTMENTS = [
  { day: 'Lun', date: '18', appointments: [{ time: '10:00', client: DEMO_CLIENTS[0], duration: 3 }, { time: '15:00', client: DEMO_CLIENTS[2], duration: 2 }] },
  { day: 'Mar', date: '19', appointments: [{ time: '14:00', client: DEMO_CLIENTS[3], duration: 4 }] },
  { day: 'Mer', date: '20', appointments: [] },
  { day: 'Jeu', date: '21', appointments: [{ time: '09:00', client: DEMO_CLIENTS[1], duration: 2 }, { time: '11:00', client: DEMO_CLIENTS[4], duration: 1 }, { time: '16:00', client: DEMO_CLIENTS[5], duration: 2 }] },
  { day: 'Ven', date: '22', appointments: [{ time: '10:00', client: DEMO_CLIENTS[6], duration: 5 }] },
  { day: 'Sam', date: '23', appointments: [{ time: '11:00', client: DEMO_CLIENTS[7], duration: 2 }] },
...
const ONBOARDING_STEPS = [
  {
    ...
    description: 'Découvrez comment gérer votre studio de tatouage comme un pro. Cette démo vous guide à travers les fonctionnalités clés.',
    icon: Sparkles,
    highlight: null,
  },
  {
    ...
    description: 'C\'est le cœur d\'InkFlow ! Créez une page professionnelle où vos clients peuvent voir votre portfolio, vos flashs disponibles et réserver directement.',
    icon: Globe,
    highlight: 'vitrine',
  ...
  },
  {
    ...
    description: 'Recevez les demandes de RDV en temps réel. Acceptez, refusez ou envoyez un lien de paiement d\'acompte en un clic.',
    icon: MessageCircle,
    highlight: 'requests',
  },
  {
    ...
    description: 'Tous vos clients au même endroit : historique, notes, projets en cours. Identifiez vos VIP automatiquement.',
    icon: Users,
    highlight: 'clients',
  },
  {
...
function NavItem({ item, depth = 0, activeId, onSelect, expandedMenus, setExpandedMenus }: NavItemProps) {
  ...
  return (
    <div>
      ...
      >
        {item.icon && (
          <item.icon className={`w-4 h-4 flex-shrink-0 ${isActive ? "text-blue-600 dark:text-blue-400" : "text-zinc-400 dark:text-zinc-500 group-hover:text-zinc-600 dark:group-hover:text-zinc-300"}`} />
        )}
        {!item.icon && depth > 0 && (
          <span className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ml-1 ${isActive ? 'bg-blue-500' : 'bg-zinc-300 dark:bg-zinc-600'}`} />
        )}
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-zinc-500 dark:text-zinc-400 mt-1">Gérez vos revenus, acomptes et statistiques</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 sm:p-5">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs sm:text-sm font-medium text-zinc-500 dark:text-zinc-400">CA Total</span>
            <div className="p-2 rounded-xl bg-green-50 dark:bg-green-500/10"><TrendingUp className="w-4 h-4 text-green-600 dark:text-green-400" /></div>
          </div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 sm:p-5">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs sm:text-sm font-medium text-zinc-500 dark:text-zinc-400">Acomptes</span>
            <div className="p-2 rounded-xl bg-purple-50 dark:bg-purple-500/10"><CreditCard className="w-4 h-4 text-purple-600 dark:text-purple-400" /></div>
          </div>
          <div className="text-xl sm:text-2xl font-bold text-purple-600 dark:text-purple-400 tabular-nums">{totalDeposits}€</div>
        </div>
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 sm:p-5">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs sm:text-sm font-medium text-zinc-500 dark:text-zinc-400">Ce mois</span>
            <div className="p-2 rounded-xl bg-blue-50 dark:bg-blue-500/10"><Calendar className="w-4 h-4 text-blue-600 dark:text-blue-400" /></div>
          </div>
          <div className="text-xl sm:text-2xl font-bold text-zinc-900 dark:text-white tabular-nums">2 450€</div>
        </div>
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 sm:p-5">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs sm:text-sm font-medium text-zinc-500 dark:text-zinc-400">En attente</span>
            <div className="p-2 rounded-xl bg-orange-50 dark:bg-orange-500/10"><Clock className="w-4 h-4 text-orange-600 dark:text-orange-400" /></div>
          </div>
          <div className="text-xl sm:text-2xl font-bold text-orange-600 dark:text-orange-400 tabular-nums">180€</div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
        <div className="px-5 py-4 border-b border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
          ...
          <span className="text-xs font-medium text-zinc-500 bg-zinc-100 dark:bg-zinc-800 px-2 py-1 rounded-lg">{DEMO_TRANSACTIONS.length}</span>
        </div>
        <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
          {DEMO_TRANSACTIONS.map((tx) => (
            <div key={tx.id} className="px-5 py-4 flex items-center gap-4 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
              <img src={tx.client.avatar} alt={tx.client.name} className="w-10 h-10 rounded-xl object-cover" />
              <div className="flex-1 min-w-0">
                <p className="font-medium text-zinc-900 dark:text-white truncate">{tx.client.name}</p>
                <p className="text-sm text-zinc-500 dark:text-zinc-400">{tx.date} • {tx.method}</p>
              </div>
              <span className={`px-2.5 py-1 rounded-lg text-xs font-medium ${tx.type === 'deposit' ? 'bg-purple-50 text-purple-700 dark:bg-purple-500/10 dark:text-purple-400' : 'bg-green-50 text-green-700 dark:bg-green-500/10 dark:text-green-400'}`}>
                {tx.type === 'deposit' ? 'Acompte' : 'Paiement'}
              </span>
              <span className="font-bold text-zinc-900 dark:text-white tabular-nums">+{tx.amount}€</span>
            </div>
          ))}
        </div>
      </div>
...
const DemoPlanningPage: React.FC = () => (
  <div className="space-y-6 animate-fade-in">
    <div>
      <h1 className="text-2xl sm:text-3xl font-bold text-zinc-900 dark:text-white tracking-tight">Planning</h1>
      <p className="text-zinc-500 dark:text-zinc-400 mt-1">Gérez vos rendez-vous et disponibilités</p>
    </div>

    <div className="flex gap-2 mb-4">
      <button className="px-4 py-2 rounded-xl bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 text-sm font-medium">Semaine</button>
      <button className="px-4 py-2 rounded-xl bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 text-sm font-medium hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors">Mois</button>
    </div>
      ...
      <div className="grid grid-cols-7 divide-x divide-zinc-100 dark:divide-zinc-800">
        {DEMO_WEEK_APPOINTMENTS.map((day) => (
          <div key={day.day} className="min-h-[300px]">
            <div className={`px-3 py-2 text-center border-b border-zinc-100 dark:border-zinc-800 ${day.appointments.length === 0 ? 'bg-zinc-50 dark:bg-zinc-800/50' : ''}`}>
            ...
            <div className="p-2 space-y-2">
              {day.appointments.map((apt, i) => (
                <div key={i} className="p-2 rounded-lg bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20">
                  <p className="text-xs font-medium text-blue-700 dark:text-blue-400">{apt.time}</p>
                  <p className="text-xs text-zinc-600 dark:text-zinc-400 truncate">{apt.client.name}</p>
...
const DemoRequestsPage: React.FC = () => (
  <div className="space-y-6 animate-fade-in">
    <div className="flex items-center justify-between">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-zinc-900 dark:text-white tracking-tight">Demandes</h1>
        <p className="text-zinc-500 dark:text-zinc-400 mt-1">{DEMO_REQUESTS.length} demandes en attente</p>
      </div>
    </div>
    ...
    <div className="flex gap-1.5 mb-4">
      <button className="px-4 py-2.5 rounded-xl bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 text-sm font-medium flex items-center gap-2">
        En attente <span className="px-1.5 py-0.5 rounded-md bg-white/20 dark:bg-zinc-900/20 text-[10px] font-bold">{DEMO_REQUESTS.length}</span>
      </button>
      <button className="px-4 py-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 text-sm font-medium">Acceptées</button>
      <button className="px-4 py-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 text-sm font-medium">Refusées</button>
    </div>

    <div className="space-y-3">
      {DEMO_REQUESTS.map((req) => (
        <div key={req.id} className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-5 hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors">
          <div className="flex items-start gap-4">
            <img src={req.client.avatar} alt={req.client.name} className="w-12 h-12 rounded-xl object-cover flex-shrink-0" />
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <p className="font-semibold text-zinc-900 dark:text-white">{req.client.name}</p>
                <span className={`px-2 py-0.5 rounded-lg text-[10px] font-bold uppercase ${
                  req.type === 'rdv' ? 'bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-400' :
                  req.type === 'flash' ? 'bg-purple-100 text-purple-700 dark:bg-purple-500/20 dark:text-purple-400' :
  ...
  <div className="space-y-6 animate-fade-in">
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-zinc-500 dark:text-zinc-400 mt-1">{DEMO_CLIENTS.length} clients au total</p>
      </div>
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4">
        ...
        <div className="text-2xl font-bold text-zinc-900 dark:text-white">{DEMO_CLIENTS.length}</div>
      </div>
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4">
        <div className="flex items-center justify-between mb-2">
        ...
        <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{DEMO_CLIENTS.filter(c => c.status === 'vip').length}</div>
      </div>
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4">
        <div className="flex items-center justify-between mb-2">
        ...
        <div className="text-2xl font-bold text-green-600 dark:text-green-400">{DEMO_CLIENTS.reduce((s, c) => s + c.totalSpent, 0).toLocaleString('fr-FR')}€</div>
      </div>
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4">
        <div className="flex items-center justify-between mb-2">
        ...
        <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{DEMO_CLIENTS.reduce((s, c) => s + c.appointmentsCount, 0)}</div>
      </div>
    </div>
    ...
    <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
      <div className="px-5 py-4 border-b border-zinc-100 dark:border-zinc-800 flex items-center gap-3">
        <div className="flex-1 relative">
          ...
          <input type="search" placeholder="Rechercher un client..." className="w-full pl-10 pr-4 py-2 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-sm" />
        </div>
      </div>
      <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
        {DEMO_CLIENTS.map((client) => (
          <div key={client.id} className="px-5 py-4 flex items-center gap-4 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors cursor-pointer">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                {client.status === 'vip' && <Star className="w-3.5 h-3.5 text-yellow-500 fill-yellow-500" />}
              </div>
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400">{client.appointmentsCount} RDV</p>
            </div>
...
const DemoVitrinePage: React.FC = () => (
  <div className="space-y-6 animate-fade-in">
    <div className="flex items-center justify-between">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-zinc-900 dark:text-white tracking-tight">Ma Vitrine</h1>
        <p className="text-zinc-500 dark:text-zinc-400 mt-1">Gérez votre page publique et vos flashs</p>
      </div>
      <a href="/studio/demo" className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium text-sm flex items-center gap-2">
    ...
    <div className="p-5 rounded-2xl bg-gradient-to-br from-purple-50 via-blue-50 to-cyan-50 dark:from-purple-500/10 dark:via-blue-500/10 dark:to-cyan-500/10 border border-blue-100 dark:border-blue-500/20">
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <h3 className="font-bold text-zinc-900 dark:text-white text-lg">inkflow.app/studio/demo</h3>
          <div className="flex items-center gap-4 text-sm text-zinc-500 dark:text-zinc-400">
            <span className="flex items-center gap-1"><Eye className="w-4 h-4" /> 247 vues</span>
            <span className="flex items-center gap-1"><MessageCircle className="w-4 h-4" /> 12 demandes</span>
            <span className="flex items-center gap-1"><Heart className="w-4 h-4" /> 34 favoris</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        {DEMO_FLASH_GALLERY.map((flash) => (
          <div key={flash.id} className="group relative rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-800">
            <img src={flash.image} alt={flash.title} className="w-full aspect-square object-cover" />
            ...
            {!flash.available && (
              <div className="absolute top-2 right-2 px-2 py-0.5 rounded-md bg-red-500 text-white text-[10px] font-bold">Réservé</div>
            )}
          </div>
        ))}
      </div>
...
const DemoPortfolioPage: React.FC = () => (
  <div className="space-y-6 animate-fade-in">
    <div className="flex items-center justify-between">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-zinc-900 dark:text-white tracking-tight">Portfolio</h1>
        <p className="text-zinc-500 dark:text-zinc-400 mt-1">Vos réalisations et projets terminés</p>
      </div>
      <button className="px-5 py-2.5 rounded-xl bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-medium text-sm flex items-center gap-2">
        <Plus className="w-4 h-4" /> Ajouter
      </button>
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
      {DEMO_FLASH_GALLERY.map((item, i) => (
        <div key={item.id} className="group relative rounded-2xl overflow-hidden border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
          <img src={item.image} alt={item.title} className="w-full aspect-[4/5] object-cover" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-4">
            <p className="text-white font-medium">{item.title}</p>
            <p className="text-white/70 text-sm">{['Avant-bras', 'Dos', 'Cuisse', 'Poignet', 'Épaule', 'Cheville'][i % 6]}</p>
          </div>
        </div>
      ))}
    </div>
...
const DemoSettingsPage: React.FC = () => (
  <div className="space-y-6 animate-fade-in">
    <div>
      <h1 className="text-2xl sm:text-3xl font-bold text-zinc-900 dark:text-white tracking-tight">Paramètres</h1>
      <p className="text-zinc-500 dark:text-zinc-400 mt-1">Gérez votre compte et préférences</p>
    </div>

    <div className="flex gap-1.5 mb-4">
      <button className="px-4 py-2.5 rounded-xl bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 text-sm font-medium">Mon compte</button>
      <button className="px-4 py-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 text-sm font-medium">Abonnement</button>
      <button className="px-4 py-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 text-sm font-medium">Notifications</button>
    </div>

    <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6">
      <h3 className="font-semibold text-zinc-900 dark:text-white mb-4">Informations personnelles</h3>
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <button className="mt-2 text-sm text-blue-600 dark:text-blue-400 font-medium">Changer la photo</button>
        </div>
      </div>
      
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">Nom du studio</label>
          <input type="text" value="Demo Studio" readOnly className="w-full px-4 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-zinc-900 dark:text-white" />
        </div>
        <div>
          <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">Email</label>
          <input type="email" value="demo@inkflow.app" readOnly className="w-full px-4 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-zinc-900 dark:text-white" />
        </div>
        <div>
          <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">Téléphone</label>
          <input type="tel" value="+33 6 00 00 00 00" readOnly className="w-full px-4 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-zinc-900 dark:text-white" />
        </div>
        <div>
          <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">Adresse</label>
          <input type="text" value="Paris, France" readOnly className="w-full px-4 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-zinc-900 dark:text-white" />
        </div>
      </div>
    </div>
  </div>
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl max-w-lg w-full overflow-hidden animate-scale-in">
        ...
        <div className="p-6 sm:p-8">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-6">{step.description}</p>
          ...
          {step.id === 'vitrine' && (
            <div className="mb-6 p-4 rounded-2xl bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-500/10 dark:to-purple-500/10 border border-blue-100 dark:border-blue-500/20">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-semibold text-zinc-900 dark:text-white mb-1">Votre page publique professionnelle</p>
                  <ul className="text-sm text-zinc-600 dark:text-zinc-400 space-y-1">
                    <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /> Portfolio & flashs disponibles</li>
                    <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /> Formulaire de réservation intégré</li>
                    <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /> Lien unique à partager</li>
                  </ul>
                </div>
              </div>
            </div>
...
export const DashboardDemoPage: React.FC = () => {
  ...
  const upcomingAppointments = demoAppointments.filter(a => a.date > today && ['pending', 'confirmed'].includes(a.status)).slice(0, 5);
  
  const monthlyRevenue = demoAppointments
    .filter(a => a.status === 'completed' && a.date.startsWith(now.toISOString().slice(0, 7)))
    .reduce((sum, a) => sum + a.price, 0);
  const totalRevenue = demoAppointments.filter(a => a.status === 'completed').reduce((sum, a) => sum + a.price, 0);
  const pendingDeposits = demoAppointments.filter(a => a.depositPaid && ['pending', 'confirmed'].includes(a.status)).reduce((sum, a) => sum + a.deposit, 0);
  const unpaidCount = demoAppointments.filter(a => !a.depositPaid && a.status !== 'cancelled').length;
  
  const topClients = [...demoClients].sort((a, b) => b.totalSpent - a.totalSpent).slice(0, 5);
  const vipCount = demoClients.filter(c => c.status === 'vip').length;
  const appointmentsThisMonth = demoAppointments.filter(a => a.date.startsWith(now.toISOString().slice(0, 7))).length;
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black flex">
      ...
      {/* Sidebar */}
      <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-60 flex-shrink-0 bg-white dark:bg-zinc-950 flex flex-col h-screen border-r border-zinc-200 dark:border-zinc-800 transform transition-transform duration-200 ease-out lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        {/* Logo */}
        <div className="px-4 py-4 border-b border-zinc-100 dark:border-zinc-800/50 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-zinc-900 dark:text-white text-sm leading-tight">InkFlow</p>
        ...
        <header className="h-14 sm:h-16 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-4 sm:px-6 flex items-center justify-between gap-4 sticky top-0 z-30">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-2 px-3 py-2 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 w-64 lg:w-80">
              ...
              />
              <kbd className="hidden lg:inline-flex items-center px-1.5 py-0.5 text-[10px] font-medium text-zinc-400 bg-zinc-200 dark:bg-zinc-800 rounded">⌘K</kbd>
            </div>
          </div>
                ...
                <div className="lg:col-span-8 space-y-6">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white dark:bg-zinc-900 rounded-2xl p-5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)]">
                      ...
                      <p className="text-xl font-bold text-zinc-900 dark:text-white tabular-nums">{demoClients.length}</p>
                    </div>
                    <div className="bg-white dark:bg-zinc-900 rounded-2xl p-5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)]">
                      <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)]">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button onClick={() => setActiveId('finance')} className="text-xs font-medium text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white flex items-center gap-1 transition-colors">
                    ...
                    <div className="h-32 bg-gradient-to-t from-blue-50 to-transparent dark:from-blue-500/5 rounded-xl flex items-end justify-around px-4 pb-4">
                      {[40, 65, 45, 80, 60, 90, 75].map((h, i) => (
                        <div key={i} className="w-8 bg-blue-500/80 dark:bg-blue-400/60 rounded-t-lg" style={{ height: `${h}%` }} />
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)] overflow-hidden">
                    <div className="px-6 py-5 flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-lg font-semibold text-zinc-900 dark:text-white mt-0.5">{todayAppointments.length} rendez-vous</p>
                      </div>
                      ...
                      {todayAppointments.length > 0 ? (
                        <div className="space-y-3">
                          {todayAppointments.slice(0, 5).map((apt) => (
                            <div key={apt.id} className="flex items-center gap-4 p-4 rounded-2xl bg-zinc-50/80 dark:bg-zinc-800/50 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all text-left group cursor-pointer">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-zinc-500 dark:text-zinc-400 truncate">{apt.service}</p>
                              </div>
                              <div className="flex items-center gap-2">
                                {apt.price && (
                    ...
                    {upcomingAppointments.length > 0 && (
                      <div className="px-6 py-5 border-t border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-800/20">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <button onClick={() => setActiveId('planning')} className="text-xs font-medium text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300">
                            Voir tout
                          </button>
                        </div>
                        <div className="space-y-2">
                          {upcomingAppointments.slice(0, 3).map(apt => (
                            <div key={apt.id} className="flex items-center gap-3 p-3 rounded-xl hover:bg-white dark:hover:bg-zinc-800 transition-colors text-left cursor-pointer">
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-indigo-600 via-blue-600 to-blue-500 rounded-3xl p-6 text-white shadow-2xl shadow-blue-600/30 relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        <div className="flex items-center justify-between mb-5">
                          ...
                          <span className="px-2.5 py-1 rounded-full bg-white/20 text-[10px] font-semibold">{todayAppointments[0].time}</span>
                        </div>
                        <div className="flex items-center gap-4 mb-6">
                          <img 
                          ...
                          />
                          <div className="flex-1 min-w-0">
                            <p className="text-xl font-bold truncate mb-1">{todayAppointments[0].clientName}</p>
                            ...
                            <div className="flex items-center gap-3 mt-2 text-xs">
                              ...
                              {todayAppointments[0].price && (
                                <span className="font-bold text-white">{todayAppointments[0].price}€</span>
                              )}
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)] overflow-hidden">
                    <div className="px-5 pt-5 pb-3 flex items-center justify-between">
                      <span className="text-xs font-medium text-zinc-400 dark:text-zinc-500 uppercase tracking-wider">Top clients</span>
                    </div>
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5">
                              ...
                              {client.status === 'vip' && <Star className="w-3 h-3 text-amber-500 fill-amber-500" />}
                            </div>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-semibold text-zinc-900 dark:text-white">{demoRequests.filter(r => r.status === 'PENDING').length} demandes</p>
