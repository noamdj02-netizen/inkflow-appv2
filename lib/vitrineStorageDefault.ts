...
/** Horaires « neutres » : fermé jusqu’à ce que le tatoueur les renseigne dans le dashboard. */
const emptyOpeningHours = (): VitrineData['openingHours'] => ({
  monday: { open: '10:00', close: '19:00', closed: true },
  tuesday: { open: '10:00', close: '19:00', closed: true },
  wednesday: { open: '10:00', close: '19:00', closed: true },
  thursday: { open: '10:00', close: '19:00', closed: true },
  friday: { open: '10:00', close: '20:00', closed: true },
  saturday: { open: '11:00', close: '20:00', closed: true },
  sunday: { open: '10:00', close: '19:00', closed: true },
});

/**
 * Gabarit par défaut pour un vrai slug studio : pas de texte / médias marketing ni stats fictives.
 * Le nom affiché et les photos viennent des données studio Supabase + contenu vitrine enregistré.
 */
