...
const BADGES = {
  ...
  // Premium / VIP — même teinte que les icônes (`primary`)
  vip: 'inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary',
};
